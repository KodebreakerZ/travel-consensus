...
Promise.all([
	pg.schema.dropTableIfExists('trip'),
	pg.schema.dropTableIfExists('user'),
	pg.schema.dropTableIfExists('trip-user'),
	pg.schema.dropTableIfExists('task'),
	pg.schema.dropTableIfExists('message'),
	pg.schema.dropTableIfExists('suggestion')
])
