			...
			<article>
				<div>
					<section className="text-section">
						...
						{loggedIn ? (
							<h1>Welcome to Travel-Consensus, you are logged in!</h1>
						) : (
							<h1>Welcome to Travel-Consensus!</h1>
						)}
						<p>This application demonstrates what a React.js based register/login workflow might look like on the Frontend. I used <a href="https://github.com/mxstbr/react-boilerplate">react-boilerplate</a> as a starting point — the app thus uses Redux, PostCSS, react-router, ServiceWorker, AppCache, bcrypt and lots more. See the full source code on <a href="https://github.com/travel-consensus/travel-consensus">Github</a>!</p>
